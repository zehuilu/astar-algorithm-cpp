...
if __name__ == "__main__":
    ...
    # solve it
    t0 = time.time()
    path_many, distance_vec = AStarPython.FindPathAllMP(agent_position, targets_position, world_map, MySimulator.map_width, MySimulator.map_height)
    t1 = time.time()
    ...
    # solve it
    t0 = time.time()
    path_many_2, distance_vec_2 = AStarPython.FindPathAll(agent_position, targets_position, world_map, MySimulator.map_width, MySimulator.map_height)
    t1 = time.time()
    ...
    print("norm of distance difference: ", np.linalg.norm(dist_diff_vec))
