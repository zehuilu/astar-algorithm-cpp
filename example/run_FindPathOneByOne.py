...
if __name__ == "__main__":
    ...
    agent_position, targets_position = MySimulator.generate_agents_and_targets(num_agents=1, num_targets=4)
    # solve it
    t0 = time.time()
    path_many, distance_vec = AStarPython.FindPathOneByOne(agent_position, targets_position, world_map, MySimulator.map_width, MySimulator.map_height)
    t1 = time.time()
    print("Time used for many paths is [sec]: ", t1-t0)
